...
with DAG(
    ...
    get_data = BashOperator(task_id='get_data',
                            bash_command="python3 /home/den/Projects/MLOPS_DZ4/scripts/get_data.py",
                            dag=dag)
    process_data = BashOperator(task_id='process_data',
                            bash_command="python3 /home/den/Projects/MLOPS_DZ4/scripts/process_data.py",
                            dag=dag)
    train_test_split_data = BashOperator(task_id='train_test_split_data',
                            bash_command="python3 /home/den/Projects/MLOPS_DZ4/scripts/train_test_split_data.py",
                            dag=dag)  
    train_model = BashOperator(task_id='train_model',
                            bash_command="python3 /home/den/Projects/MLOPS_DZ4/scripts/train_model.py",
                            dag=dag)
    test_model = BashOperator(task_id='test_model',
                            bash_command="python3 /home/den/Projects/MLOPS_DZ4/scripts/test_model.py",
                            dag=dag)
    optimization_gyperparametr = BashOperator(task_id='optimization_gyperparametr',
                            bash_command="python3 /home/den/Projects/MLOPS_DZ4/scripts/optimization_gyperparametr.py",
                            dag=dag)
